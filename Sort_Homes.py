...
clearCamera_2 = 0.25, -0.22, 0.20, 0, 3.14, 0
...
placeObjectHome_r1 = 0.3, -0.25, 0.15, 0, 3.14, 0
placeObjectHomeDown_r1 = 0.3, -0.25, 0.005, 0, 3.14, 0
...
def CubeToHome():
    ...
    move(rob, placeObjectHome_r1, True)
    gamma += 0.075
    placeObjectHome_r2 = 0.3, -0.25-gamma, 0.15, 0, 3.14, 0
    placeObjectHomeDown_r2 = 0.3, -0.25-gamma, 0.005, 0, 3.14, 0
    time.sleep(0.2)
    objectCount += 1
